...
const proxy = {
  ...
  'POST /statistics/TemplateExecute': (req, res) => {
    ...
    if(req.body.name==="goodsInfo"){
      ...
      data.data = [{"machineCode":"18342471","point":"点位点位点位点位点位点位点位点位点位点位点位点位点位点位点位","data":[{"date":"2018-09-25","pv":10,"uv":9,"order":9,"shipment":9,"fans":20},{"date":"2018-09-26","pv":100,"uv":99,"order":99,"shipment":99,"fans":200}]},{"machineCode":"18342472","point":"点位","data":[{"date":"2018-09-25","pv":10,"uv":9,"order":9,"shipment":9,"fans":20},{"date":"2018-09-26","pv":100,"uv":99,"order":99,"shipment":99,"fans":200}]}]
    }
    res.send(data)
  },
};
