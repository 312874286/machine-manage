        ...
        functions: [
           {
            ...
            functionId: 'a11',
            functionDepict: '微信推送设定',
            functionPath: 'wechat-push',
            parentId: 'a1',
            functionLevel: 2,
          }, {
            functionId: 'a12',
            functionDepict: '关联微信公众号',
            functionPath: 'wechat-relation',
            parentId: 'a1',
            functionLevel: 2,
          }, {
            functionId: 'a13',
            functionDepict: '基础信息设置',
            functionPath: 'merchants-basic',
            parentId: 'a1',
            functionLevel: 2,
          }, {
            functionDepict: "基础数据设置",
            functionId: "20005",
            functionLevel: 2,
            functionPath: "data",
            parentId: "a1"
          }, {
            functionDepict: "医生基础数据设置",
            functionId: "20007",
            functionLevel: 3,
            functionPath: "doctor-config-manage",
            parentId: "20005"
          }, {
            functionDepict: "医生技能数据设置",
            functionId: "20008",
            functionLevel: 3,
            functionPath: "doctor-skill-manage",
            parentId: "20005"
          }, {
            functionId: 'a14',
            functionDepict: '报警管理',
            functionPath: 'alert-manage',
            parentId: 'a1',
            functionLevel: 2,
          }, {
            functionId: 'a15',
            functionDepict: '医生墙数据设定',
            functionPath: 'doctor-wall',
            parentId: 'a1',
            functionLevel: 2,
          }, {
            functionId: 'a16',
            functionDepict: '点位管理',
            functionPath: 'pointLocationManage',
            parentId: null,
            functionLevel: 1,
            icon: 'form',
          },
          ...
          {
            functionId: 'a20',
            functionDepict: '门诊价格设定',
            functionPath: 'price-manage',
            parentId: 'a19',
            functionLevel: 2,
          },
          {
            functionId: 'a21',
            functionDepict: '分成比例设定',
            functionPath: 'commission',
            parentId: 'a19',
            functionLevel: 2,
          },
          {
          ...
          },
          {
            functionId: 'a25',
            functionDepict: '门诊管理',
            functionPath: 'outpatient',
            parentId: 'a24',
            functionLevel: 2,
          },
          {
            functionId: 'a26',
            functionDepict: '医生建议管理',
            functionPath: 'suggest',
            parentId: 'a24',
            functionLevel: 2,
          },
          {
            functionId: 'a27',
            functionDepict: '医生技能管理',
            functionPath: 'skill',
            parentId: 'a19',
            functionLevel: 2,
          },
          {
            functionId: 'a28',
            functionDepict: '在线医生管理',
            functionPath: 'doctor-online',
            parentId: 'a19',
            functionLevel: 2,
          },
          {
          ...
          {
            functionId: 'a30',
            functionDepict: '服务项管理',
            functionPath: 'service',
            parentId: 'a29',
            functionLevel: 2,
          },
          {
            functionId: 'a31',
            functionDepict: '操作项管理',
            functionPath: 'operation-item',
            parentId: 'a30',
            functionLevel: 3,
          },
          {
            functionId: 'a32',
            functionDepict: '服务项管理',
            functionPath: 'service-item',
            parentId: 'a30',
            functionLevel: 3,
          },
          {
            functionId: 'a33',
            functionDepict: '商品规则管理',
            functionPath: 'rule',
            parentId: 'a29',
            functionLevel: 2,
          },
          {
            functionId: 'a34',
            functionDepict: '组合规则管理',
            functionPath: 'compositing',
            parentId: 'a33',
            functionLevel: 3,
          },
          {
