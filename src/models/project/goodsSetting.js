import { getGoodsSettingList, getGoodsSettingDetail, getMerchantsList, getShopsList, getActivityList, saveGoodsSetting, editGoodsSetting, delGoodsSetting } from '../../services/project/goodsSetting';

export default {
  namespace: 'goodsSetting',
  state: {
    list: [],
    page: {},
    datas: {},
