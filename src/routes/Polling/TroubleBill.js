...
@connect(({ common, loading, troubleBill, log }) => ({
  common,
  troubleBill,
...
export default class troubleBill extends PureComponent {
  ...
  getLists = () => {
    this.props.dispatch({
      type: 'troubleBill/getMerchantSettingList',
      payload: {
        restParams: {
    ...
    this.props.dispatch({
      type: 'troubleBill/getChannelsList',
      payload: {
        restParams: {},
      },
    }).then((res) => {
  ...
  handleDelClick = (item) => {
    ...
    if (item) {
      ...
      this.props.dispatch({
        type: 'troubleBill/delMerchantSetting',
        payload: {
          params,
        },
      }).then(() => {
  ...
  handleEditClick = (item) => {
    ...
    this.props.dispatch({
      type: 'troubleBill/getMerchantSettingDetail',
      payload: {
        restParams: {
          id: item.id,
        },
  ...
  handleAdd = () => {
    this.form.validateFields((err, values) => {
      ...
      let url = 'troubleBill/saveMerchantSetting';
      let params = { ...values };
      if (this.state.modalData.id) {
        url = 'troubleBill/editMerchantSetting';
